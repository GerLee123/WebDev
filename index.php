...
<!--/ .row promo teaser--> 
	...
	<div class="row">
	<?php
	if (isset($_POST['addtocart']) && isset($_SESSION['login_user'])) {
...
if(mysql_affected_rows()>=1 && isset($_SESSION['login_user'])){
echo '<script language="javascript">';
echo 'alert("Game Has Been Added to Cart")';
echo '</script>';

}else{
echo '<script language="javascript">';
echo 'alert("You Must Log In to Add to Cart")';
echo '</script>';
...
if(mysql_num_rows($query)){
	...
	?>
            ...
            <div class="col-md-4">
                <div class="thumbnail">
				<br>
                    <a href="game.php?id=<?php echo $id?>"><img src="<?php echo $myimage?>" alt="<?php echo $myname?>"></a>
                    <div class="caption">
						...
						<a href="game.php?id=<?php echo $id?>" class="btn btn-primary">More Info</a> 
